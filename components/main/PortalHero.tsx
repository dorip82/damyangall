...
export function PortalHero() {
  return (
    <section className="relative flex min-h-[60vh] flex-col items-center justify-center gap-5 overflow-hidden px-6 py-20 text-center text-ivory">
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img
        src="/images/sorihyanggi-hero.webp"
        alt=""
        className="animate-slow-zoom absolute inset-0 h-full w-full object-cover motion-reduce:animate-none"
      />
      <div className="absolute inset-0 bg-deep-forest/60" aria-hidden />
